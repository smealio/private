...
namespace CTCA.Telehealth.Microsoft.Common
{
    internal abstract class ApiRequest<TResponseType>
    {
        ...
        protected ApiRequest(
            MicrosoftGraphApiClientSettings clientSettings,
            HttpMethod method,
        ...
        private HttpRequestMessage GetRequestMessage()
        {
            ...
            httpRequest.Headers.Authorization = new AuthenticationHeaderValue("Bearer", _accessToken.AccessToken);
        ...
        public async Task HandleErrorResponse(HttpResponseMessage response)
        {
            ...
            const string message = "Payment operation failure. ";
        ...
        private void AddRequiredHeaders(HttpRequestMessage request)
        {
            ...
            //  var auth = string.IsNullOrEmpty(_accessToken.AccessToken) ? null : new AuthenticationHeaderValue("Bearer ", _accessToken.AccessToken);
        }
    }
}
