...
namespace CTCA.Telehealth.Microsoft.Models.EWS.Create
{
    ...
    public class EwsCreateItem
    {
        ...
        public EwsCreateItem(string impersonateId, string subject, string body, string start, string end, string location, string timezone)
        {
