...
{
    internal class ReadinessCheckCalendarApiRequest : ApiRequest<(TelehealthAppointment, ServiceError)>
    {

        private readonly TelehealthAppointment _request;
        private readonly ILogger _logger;

        public ReadinessCheckCalendarApiRequest(MicrosoftGraphApiClientSettings clientSettings, TelehealthAppointment request,
        ...
        protected override object GetPayload()
        {
            ...
            {
                subject = "CTCA Readiness Check Appointment",
                body = new Body
                {
                    contentType = "HTML",
