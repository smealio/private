...
{
    internal class ReadinessCheckEmailApiRequest : ApiRequest<(bool, ServiceError)>
    {
        ...
        public ReadinessCheckEmailApiRequest(MicrosoftGraphApiClientSettings clientSettings, EmailSettings emailSettings, TelehealthAppointment request,
        ...
        protected override object GetPayload()
        {
            ...
            var payload = new MicrosoftMailRequest
            {
                Message = new Message
                {
                    Subject = "Your Tech Support Call with CTCA",
                    Body = new Body
                    {
                        ContentType = "HTML",
        ...
        {
            return CTCA.Telehealth.Shared.Resources.ResourceAccessor.GetReadinessCheckTemplate();
