...
{
    internal class MeetingApiRequest : ApiRequest<TelehealthAppointment>
    {

        private readonly TelehealthAppointment _request;
        private readonly ILogger _logger;

        public MeetingApiRequest(MicrosoftGraphApiClientSettings clientSettings, TelehealthAppointment request,
        ...
        protected override object GetPayload()
        {
            ...
            var payload = new MicrosoftMeetingRequest
            {
                ...
                _subject = "Telehealth Appointment"
            };
