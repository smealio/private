...
public class LoadingOverlay{
    ...
    public func showOverlay(view: UIView, message: String? = nil) {
        ...
        self.overlayView.backgroundColor = MyCTCAColor.overlayBackground.color
        self.overlayView.clipsToBounds = true
        self.overlayView.alpha = 1.0
        
        self.activityIndicator.frame = CGRect(x: 0, y: 0, width: 40.0, height: 40.0)
        self.activityIndicator.style = .whiteLarge
        self.activityIndicator.color = MyCTCAColor.ctcaGreen.color
        ...
        if (message != nil) {
            ...
            self.messageLabel.textColor = MyCTCAColor.ctcaGrey.color
