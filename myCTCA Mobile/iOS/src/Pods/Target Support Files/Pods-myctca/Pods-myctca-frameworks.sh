...
if [[ "$CONFIGURATION" == "Debug (dev)" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/AzureCommunicationCommon/AzureCommunicationCommon.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/AzureCommunicationCalling/AzureCommunicationCalling.framework"
fi
