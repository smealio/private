...
if [[ "$CONFIGURATION" == "Debug (dev)" ]]; then
  install_xcframework "${PODS_ROOT}/AppCenter/AppCenter-SDK-Apple/AppCenterAnalytics.xcframework" "" "false" "ios-arm64_arm64e_armv7_armv7s/AppCenterAnalytics.framework" "ios-arm64_i386_x86_64-simulator/AppCenterAnalytics.framework" "ios-arm64_x86_64-maccatalyst/AppCenterAnalytics.framework"
  install_xcframework "${PODS_ROOT}/AppCenter/AppCenter-SDK-Apple/AppCenter.xcframework" "" "false" "ios-arm64_x86_64-maccatalyst/AppCenter.framework" "ios-arm64_i386_x86_64-simulator/AppCenter.framework" "ios-arm64_arm64e_armv7_armv7s/AppCenter.framework"
  install_xcframework "${PODS_ROOT}/AppCenter/AppCenter-SDK-Apple/AppCenterCrashes.xcframework" "" "false" "ios-arm64_i386_x86_64-simulator/AppCenterCrashes.framework" "ios-arm64_x86_64-maccatalyst/AppCenterCrashes.framework" "ios-arm64_arm64e_armv7_armv7s/AppCenterCrashes.framework"
  install_xcframework "${PODS_ROOT}/AzureCommunicationCalling/AzureCommunicationCalling.xcframework" "" "true" "ios-arm64/AzureCommunicationCalling.framework" "ios-x86_64-simulator/AzureCommunicationCalling.framework"
fi
