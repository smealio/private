...
install_xcframework "${PODS_ROOT}/AzureCommunicationCalling/AzureCommunicationCalling.xcframework" "AzureCommunicationCalling" "framework" "ios-x86_64-simulator" "ios-arm64"
